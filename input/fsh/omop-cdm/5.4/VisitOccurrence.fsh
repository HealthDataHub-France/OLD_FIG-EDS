...
* visit_concept_id	1..1	Reference(Concept)	"Visit" "This field contains a concept id representing the kind of visit, like inpatient or outpatient. All concepts in this field should be standard and belong to the Visit domain."
...
* visit_type_concept_id	1..1	Reference(Concept)	"Visit Type" "Use this field to understand the provenance of the visit record, or where the record comes from."
...
* visit_source_concept_id	0..1	Reference(Concept)	"Visit Source Concept" ""
* admitted_from_concept_id	0..1	Reference(Concept)	"Admitted From Concept" "Use this field to determine where the patient was admitted from. This concept is part of the visit domain and can indicate if a patient was admitted to the hospital from a long-term care facility, for example."
* admitted_from_source_value	0..1	string	"Admitted From Source Value" ""
* discharged_to_concept_id	0..1	Reference(Concept)	"Discharged To Concept" ""
