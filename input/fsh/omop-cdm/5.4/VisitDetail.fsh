...
* visit_detail_concept_id 1..1	Reference(Concept)	"Visit Detail" "This field contains a concept id representing the kind of visit detail, like inpatient or outpatient. All concepts in this field should be standard and belong to the Visit domain."
...
* visit_detail_type_concept_id	1..1	Reference(Concept)	"Visit Detail Type" "Use this field to understand the provenance of the visit detail record, or where the record comes from."
...
* visit_detail_source_concept_id	0..1	Reference(Concept)	"Visit Detail Source Concept" ""
* admitted_from_concept_id	0..1	Reference(Concept)	"Admitted From" "Use this field to determine where the patient was admitted from. This concept is part of the visit domain and can indicate if a patient was admitted to the hospital from a long-term care facility, for example."
...
* discharged_to_concept_id	0..1	Reference(Concept)	"Discharged To" "Use this field to determine where the patient was discharged to after a visit. This concept is part of the visit domain and can indicate if a patient was transferred to another hospital or sent to a long-term care facility, for example.  It is assumed that a person is discharged to home therefore there is not a standard concept id for \"home\".  Use concept id = 0 when a person is discharged to home."
