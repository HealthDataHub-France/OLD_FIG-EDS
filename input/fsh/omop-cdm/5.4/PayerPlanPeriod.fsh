...
* payer_plan_period_id 1..1 integer "Payer Plan Period Identifier" ""
...
* payer_concept_id 0..1 Reference(Concept) "Payer" "This field represents the organization who reimburses the provider which administers care to the Person."
* payer_source_value 0..1 string "Payer Source Value" "This is the Payer as it appears in the source data."
* payer_source_concept_id 0..1 Reference(Concept) "Payer Source" ""
* plan_concept_id 0..1 Reference(Concept) "Plan" "This field represents the specific health benefit Plan the Person is enrolled in."
...
* plan_source_concept_id 0..1 Reference(Concept) "Plan Source" ""
* sponsor_concept_id 0..1 Reference(Concept) "Sponsor" "This field represents the sponsor of the Plan who finances the Plan. This includes self-insured, small group health plan and large group health plan."
* sponsor_source_value 0..1 string "Sponsor Source Value" "The Plan sponsor as it appears in the source data."
* sponsor_source_concept_id 0..1 Reference(Concept) "Sponsor Source" ""
...
* stop_reason_concept_id 0..1 Reference(Concept) "Stop Reason" "This field represents the reason the Person left the Plan, if known."
* stop_reason_source_value 0..1 string "Stop Reason Source Value" "The Plan stop reason as it appears in the source data."
* stop_reason_source_concept_id 0..1 Reference(Concept) "Stop Reason Source" ""
