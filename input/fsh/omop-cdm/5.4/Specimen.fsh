...
* specimen_id 1..1 integer "Specimen Identifier" ""
* person_id 1..1 Reference(Person) "Person" "The person from whom the specimen is collected."
* specimen_concept_id 1..1  Reference(Concept) "Specimen" ""
* specimen_type_concept_id 1..1 Reference(Concept) "Specimen Type" ""
...
* unit_concept_id 0..1 Reference(Concept) "Unit" "The unit for the quantity of the specimen."
* anatomic_site_concept_id 0..1 Reference(Concept) "Anatomic Site" "This is the site on the body where the specimen is from."
* disease_status_concept_id  0..1 Reference(Concept) "Disease Status" ""
