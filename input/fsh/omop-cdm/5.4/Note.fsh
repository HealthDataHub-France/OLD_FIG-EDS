...
* note_id 1..1 integer "Note Identifier" ""
...
* note_type_concept_id 1..1 Reference(Concept) "Note Type" "The provenance of the note. Most likely this will be EHR."
* note_class_concept_id 1..1 Reference(Concept) "Note Class" "A Standard Concept Id representing the HL7 LOINC
...
* encoding_concept_id 1..1 Reference(Concept) "Encoding" "This is the Concept representing the character encoding type."
* language_concept_id 1..1 Reference(Concept) "Language" "The language of the note."
...
* note_event_field_concept_id 0..1 Reference(Concept) "Note Event Field" "If the Note record is related to another record in the database, this field is the CONCEPT_ID that identifies which table the primary key of the linked record came from."
