...
* death_type_concept_id 0..1 Reference(Concept) "Death Type" "This is the provenance of the death record, i.e., where it came from. It is possible that an administrative claims database would source death information from a government file so do not assume the Death Type is the same as the Visit Type, etc."
...
* cause_source_concept_id 0..1 Reference(Concept) "Cause Source"
