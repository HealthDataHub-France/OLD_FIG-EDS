...
* episode_id 1..1 integer "Episode Identifier" ""
* person_id 1..1 Reference(Person) "Person" "The PERSON_ID of the PERSON for whom the episode is recorded."
* episode_concept_id 1..1 Reference(Concept) "Episode" "The EPISODE_CONCEPT_ID represents the kind abstraction related to the disease phase, outcome or treatment."
...
* episode_source_concept_id 0..1 Reference(Concept) "Episode Source" "A foreign key to a Episode Concept that refers to the code used in the source."
