...
* dose_era_id 1..1 Reference(Concept) "Dose Era Identifier" ""
* person_id 1..1 Reference(Person) "Person" ""
* drug_concept_id 1..1 Reference(Concept) "Drug" "The Concept Id representing the specific drug ingredient."
* unit_concept_id 1..1 Reference(Concept) "Unit" "The Concept Id representing the unit of the specific drug ingredient."
