...
* episode_event_field_concept_id 1..1 Reference(Concept) "Episode Event Field" "This field is the CONCEPT_ID that identifies which table the primary key of the linked record came from." 
