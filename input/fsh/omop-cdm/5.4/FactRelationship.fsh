...
* domain_concept_id_1 1..1 Reference(Concept) "Domain 1" ""
* fact_id_1 1..1 string "Fact Identifier 1" ""
* domain_concept_id_2 1..1 Reference(Concept) "Domain 2" ""
* fact_id_2 1..1 string "Fact Identifier 2" ""
* relationship_concept_id 1..1 Reference(Concept) "Relationship" ""
