...
* gender_concept_id	0..1	Reference(Concept)	"Gender" "This field represents the recorded gender of the provider in the source data."
...
* specialty_source_concept_id	0..1	Reference(Concept)	"Specialty Source Concept" "This is often zero as many sites use proprietary codes to store physician speciality."
* gender_source_value	0..1	string	"Gender Source Value" "This is provider's gender as it appears in the source data."
* gender_source_concept_id	0..1	Reference(Concept)	"Gender Source Concept" "This is often zero as many sites use proprietary codes to store provider gender."
