...
* gender_concept_id 1..1 Reference(Concept) "Gender" "This field is meant to capture the biological sex at birth of the Person. This field should not be used to study gender identity issues."
...
* race_concept_id 1..1 Reference(Concept) "Race" "This field captures race or ethnic background of the person."
* ethnicity_concept_id 1..1 Reference(Concept) "Ethnicity" "This field captures Ethnicity as defined by the Office of Management and Budget (OMB) of the US Government: it distinguishes only between “Hispanic” and “Not Hispanic”. Races and ethnic backgrounds are not stored here."
...
* gender_source_concept_id 0..1 Reference(Concept) "Gender Source Concept" "If the source data codes biological sex in a non-standard vocabulary, store the concept_id here."
...
* race_source_concept_id 0..1 Reference(Concept) "Race Source Concept" "If the source data codes race in an OMOP supported vocabulary store the concept_id here."
...
* ethnicity_source_concept_id 0..1 Reference(Concept) "Ethnicity Source Concept" "If the source data codes ethnicity in an OMOP supported vocabulary, store the concept_id here."